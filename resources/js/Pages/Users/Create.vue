<template>
  <AppLayout
    title="Nuevo usuario"
    :breadcrumbs="[{ label: 'Usuarios', href: route('users.index') }, { label: 'Nuevo usuario' }]"
  >
    <div class="mx-auto max-w-xl">
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" v-model="form.name" :class="inputClass" placeholder="Ej: Juan Pérez"/>
            ...
            <div>
              ...
              <input type="email" v-model="form.email" :class="inputClass" placeholder="juan@empresa.cl"/>
            ...
            <div>
              ...
              <input type="password" v-model="form.password" :class="inputClass"
                     placeholder="Mínimo 8 caracteres con letras y números" autocomplete="new-password"/>
        ...
        <!-- Asignación de proyectos (solo developers) -->
        <Transition
        ...
        >
          <div v-if="form.role === 'developer'" class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div v-if="projects.length === 0" class="text-sm text-gray-400">
...
const roleOptions = [
  {
    value: 'admin',
    label: 'Administrador',
    description: 'Acceso total al sistema. Puede gestionar usuarios, clientes, proyectos y finanzas.',
  },
  {
    value: 'developer',
    label: 'Desarrollador',
    description: 'Solo ve proyectos asignados y sus tareas.',
  },
];
